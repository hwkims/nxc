      ...
      getTranslate: function (e, t) {
        ...
        return (
          J.WebKitCSSMatrix
            ...
            : (a = (s =
                r.MozTransform || r.OTransform || r.MsTransform || r.msTransform || r.transform || r.getPropertyValue('transform').replace('translate(', 'matrix(1, 0, 0, 1,'))
                .toString()
                .split(',')),
        ...
        for (var a = Object(e[0]), i = 1; i < e.length; i += 1) {
          ...
          if (null != s)
            for (var r = Object.keys(Object(s)), n = 0, o = r.length; n < o; n += 1) {
              ...
              void 0 !== d &&
                d.enumerable &&
                (ee.isObject(a[l]) && ee.isObject(s[l]) ? ee.extend(a[l], s[l]) : !ee.isObject(a[l]) && ee.isObject(s[l]) ? ((a[l] = {}), ee.extend(a[l], s[l])) : (a[l] = s[l]));
            }
        }
        return a;
      },
            ...
            (e.onTouchMove = function (e) {
              ...
              if ((n.originalEvent && (n = n.originalEvent), a.isTouched)) {
                if (!a.isTouchEvent || 'mousemove' !== n.type) {
                  ...
                  if (!t.allowTouchMove)
                    return (t.allowClick = !1), void (a.isTouched && (ee.extend(s, { startX: o, startY: l, currentX: o, currentY: l }), (a.touchStartTime = ee.now())));
  ...
  var A = {
        ...
        -1 < J.navigator.userAgent.indexOf('firefox')
          ...
          : (function () {
              ...
              if (!t) {
                ...
                a.setAttribute(e, 'pay;'), (t = 'function' == typeof a[e]);
              }
              return (
                !t && f.implementation && f.implementation.hasFeature && !0 !== f.implementation.hasFeature('', '') && (t = f.implementation.hasFeature('Events.wheel', '3.0')), t
              );
            })()
          ? 'wheel'
          : 'mousewheel',
    ...
    H = {
      ...
      init: function () {
        ...
        (i.nextEl || i.prevEl) &&
          (i.nextEl &&
            ((e = L(i.nextEl)), a.params.uniqueNavElements && 'string' == typeof i.nextEl && 1 < e.length && 1 === a.$el.find(i.nextEl).length && (e = a.$el.find(i.nextEl))),
          i.prevEl &&
            ((t = L(i.prevEl)), a.params.uniqueNavElements && 'string' == typeof i.prevEl && 1 < t.length && 1 === a.$el.find(i.prevEl).length && (t = a.$el.find(i.prevEl))),
        ...
        if (e.params.history) {
          ...
          (t.initialized = !0),
            ...
            (t.paths.key || t.paths.value) &&
              (t.scrollToSlide(0, t.paths.value, e.params.runCallbacksOnInit), e.params.history.replaceState || J.addEventListener('popstate', e.history.setHistoryPopState));
        }
      },
      destroy: function () {
      ...
      init: function () {
        ...
        t.swiper instanceof a
          ...
          : ee.isObject(t.swiper) &&
            ((e.thumbs.swiper = new a(ee.extend({}, t.swiper, { watchSlidesVisibility: !0, watchSlidesProgress: !0, slideToClickedSlide: !1 }))), (e.thumbs.swiperCreated = !0)),
    ...
    Q = [
      ...
      },
      {
        ...
        create: function () {
          var e = this;
          ee.extend(e, {
            navigation: { init: H.init.bind(e), update: H.update.bind(e), destroy: H.destroy.bind(e), onNextClick: H.onNextClick.bind(e), onPrevClick: H.onPrevClick.bind(e) },
          });
        },
        on: {
          init: function () {
