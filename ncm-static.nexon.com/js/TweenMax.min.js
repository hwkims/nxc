      ...
      function (a, b) {
        ...
        var Ba,
          ...
          Ta = function (a) {
            ...
            if (m) {
              ...
              if (
                (null != d.ox &&
                  ((n = (d.oxp ? q * d.ox * 0.01 : d.ox) - q / 2), (o = (d.oyp ? r * d.oy * 0.01 : d.oy) - r / 2), (u += n - (n * h + o * i)), (v += o - (n * j + o * k))),
                ...
                if (
                  ...
                  return void (B || P || L
                    ? ((B *= K),
                      ...
                      x &&
                        'simple' === z.skewType &&
                        ((b = Math.tan(x - O * K)), (b = Math.sqrt(1 + b * b)), (d *= b), (g *= b), O && ((b = Math.tan(O * K)), (b = Math.sqrt(1 + b * b)), (c *= b), (f *= b))),
                      L &&
              ...
              if ((-1 !== q.indexOf('%')) != (-1 !== r.indexOf('%')) && r.split(',').length < 2 && ((m = aa(a, 'backgroundImage').replace(D, '')), m && 'none' !== m)) {
                for (h = q.split(' '), i = r.split(' '), R.setAttribute('src', m), j = 2; --j > -1; )
                  (q = h[j]),
                    (k = -1 !== q.indexOf('%')),
                    k !== (-1 !== i[j].indexOf('%')) &&
                      ((l = 0 === j ? a.offsetWidth - R.width : a.offsetHeight - R.height), (h[j] = k ? (parseFloat(q) / 100) * l + 'px' : (parseFloat(q) / l) * 100 + '%'));
                q = h.join(' ');
              }
        ...
        var Ya = function (a) {
          if ((1 === a || 0 === a) && this.data._totalTime === this.data._totalDuration && 'isFromStart' !== this.data.data) {
            ...
            e &&
              (Wa(g, Da), (f = this.t._gsTransform), f && (f.svg && (this.t.removeAttribute('data-svg-origin'), this.t.removeAttribute('transform')), delete this.t._gsTransform));
          }
        };
        for (
          za('clearProps', {
    ...
    for (
      i = w.prototype,
        ...
        i.getRatio = function (a) {
          ...
          return (
            1 === c ? (d *= d) : 2 === c ? (d *= d * d) : 3 === c ? (d *= d * d * d) : 4 === c && (d *= d * d * d * d), 1 === b ? 1 - d : 2 === b ? d : 0.5 > a ? d / 2 : 1 - d / 2
          );
        },
    ...
    (Z._startTime = j.time),
      ...
      (E._updateRoot = H.render =
        function () {
          var a, b, c;
          if (
            (K.length && _(), Z.render((j.time - Z._startTime) * Z._timeScale, !1, !1), Y.render((j.frame - Y._startTime) * Y._timeScale, !1, !1), K.length && _(), j.frame >= $)
          ) {
        ...
        if (a >= j - n && a >= 0)
          ...
          (h._totalTime = h._time = 0),
            ...
            a > -n
              ...
              : 0 > a &&
                ((h._active = !1),
                0 === j && (h._initted || !h.vars.lazy || c) && (k >= 0 && (k !== n || 'isPause' !== h.data) && (c = !0), (h._rawPrevTime = g = !b || a || k === a ? a : n))),
        ...
        if (h._time !== i || c) {
          ...
          for (
            h._lazy !== !1 && (h._lazy = !1),
              ...
              0 === i &&
                (h._startAt && (a >= 0 ? h._startAt.render(a, !0, c) : e || (e = '_dummyGS')), h.vars.onStart && (0 !== h._time || 0 === j) && (b || h._callback('onStart'))),
              f = h._firstPT;
            f;
